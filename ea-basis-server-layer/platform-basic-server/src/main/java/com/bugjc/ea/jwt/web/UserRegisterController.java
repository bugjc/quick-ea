...
import com.bugjc.ea.auth.core.dto.JwtAuthenticationResponse;
import com.bugjc.ea.auth.core.exception.AuthenticationException;
import com.bugjc.ea.auth.core.security.JwtTokenUtil;
import com.bugjc.ea.auth.web.reqbody.userregister.RegisterGroup;
...
public class UserRegisterController {
    ...
    public Result register(@Validated({RegisterGroup.class}) @RequestBody UserRegisterRepBody userRegisterRepBody) throws AuthenticationException {
        ...
        final UserDetails userDetails = userDetailsService.loadUserByUsername(userRegisterRepBody.getUsername());
