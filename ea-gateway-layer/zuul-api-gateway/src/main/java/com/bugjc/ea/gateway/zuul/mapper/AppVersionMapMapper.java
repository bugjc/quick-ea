...
public interface AppVersionMapMapper {
     ...
     * @return
     */
    @Insert("INSERT  INTO `app_version_map`(id,`app_id`,`version_no`,`path`,`map_path`,`description`,`create_time`) VALUES \n " +
            "(#{id},#{appId},#{versionNo},#{path},#{mapPath},#{description},#{createTime});")
