-- 创建数据库和账户
CREATE DATABASE IF NOT EXISTS ea_api_gateway_server COLLATE = 'utf8_general_ci' CHARACTER SET = 'utf8';
GRANT ALL ON ea_api_gateway_server.* TO 'gateway'@'%' IDENTIFIED BY 'gateway2018';
GRANT ALL ON ea_api_gateway_server.* TO 'gateway'@'localhost' IDENTIFIED BY 'gateway2018';
