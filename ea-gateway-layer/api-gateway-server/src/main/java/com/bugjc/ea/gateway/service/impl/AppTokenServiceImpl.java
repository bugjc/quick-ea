...
import com.bugjc.ea.gateway.core.constants.AppTokenConstants;
import com.bugjc.ea.gateway.core.enums.business.AppTokenStatus;
import com.bugjc.ea.gateway.mapper.AppTokenMapper;
...
public class AppTokenServiceImpl implements AppTokenService {
    ...
    public AppToken findToken(String appId) {
        ...
        newToken.setAccessToken(UUID.randomUUID().toString());
