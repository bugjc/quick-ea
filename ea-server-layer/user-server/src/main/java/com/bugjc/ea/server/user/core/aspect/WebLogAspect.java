package com.bugjc.ea.server.user.core.aspect;

import brave.Tracer;
import com.bugjc.ea.server.user.config.ApplicationConfig;
...
public class WebLogAspect {
    ...
    @Pointcut("execution(public * com.bugjc.ea.server.user.web..*.*(..))")
    public void webLog(){}
