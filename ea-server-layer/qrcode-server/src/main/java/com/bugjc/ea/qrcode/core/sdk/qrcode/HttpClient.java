...
public class HttpClient {
	 ...
	 * @throws Exception
	 */
	public int send(Map<String, String> data, String encoding, boolean isIfValidateRemoteCert) throws Exception {
		try {
			HttpURLConnection httpURLConnection = createConnection(encoding,isIfValidateRemoteCert);
	 ...
	 * @throws Exception
	 */
	public int sendGet(String encoding,boolean isIfValidateRemoteCert) throws Exception {
		HttpURLConnection httpURLConnection = createConnectionGet(encoding,isIfValidateRemoteCert);
		if(null == httpURLConnection){
	 ...
	 */
	private HttpURLConnection createConnection(String encoding,boolean isIfValidateRemoteCert) throws ProtocolException {
	 ...
	 * @throws ProtocolException
	 */
	private HttpURLConnection createConnectionGet(String encoding,boolean isIfValidateRemoteCert) throws ProtocolException {
		HttpURLConnection httpURLConnection = null;
		try {
			httpURLConnection = (HttpURLConnection) url.openConnection();
		} catch (IOException e) {
