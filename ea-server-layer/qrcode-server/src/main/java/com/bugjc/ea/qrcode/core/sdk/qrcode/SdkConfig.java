...
//	/** 配置文件中的后台URL常量. */
//	private static final String SDK_BACK_URL = "acpsdk.backTransUrl";
//	/** 配置文件中的单笔交易查询URL常量. */
//	private static final String SDK_SIGNQ_URL = "acpsdk.singleQueryUrl";
//	/** 配置文件中的批量交易查询URL常量. */
//    private static final String SDK_BATQ_URL = "acpsdk.batchQueryUrl";
//	/** 配置文件中的批量交易URL常量. */
//    private static final String SDK_BATTRANS_URL = "acpsdk.batchTransUrl";
//	/** 配置文件中的文件类交易URL常量. */
//    private static final String SDK_FILETRANS_URL = "acpsdk.fileTransUrl";
//	/** 配置文件中的有卡交易URL常量. */
//    private static final String SDK_CARD_URL = "acpsdk.cardTransUrl";
//	/** 配置文件中的app交易URL常量. */
//    private static final String SDK_APP_URL = "acpsdk.appTransUrl";
//
//	/** 以下缴费产品使用，其余产品用不到，无视即可 */
//	// 前台请求地址
//    private static final String JF_SDK_FRONT_TRANS_URL= "acpsdk.jfFrontTransUrl";
//	// 后台请求地址
//    private static final String JF_SDK_BACK_TRANS_URL="acpsdk.jfBackTransUrl";
//	// 单笔查询请求地址
//    private static final String JF_SDK_SINGLE_QUERY_URL="acpsdk.jfSingleQueryUrl";
//	// 有卡交易地址
//    private static final String JF_SDK_CARD_TRANS_URL="acpsdk.jfCardTransUrl";
//	// App交易地址
//    private static final String JF_SDK_APP_TRANS_URL="acpsdk.jfAppTransUrl";
//	// 人到人
//    private static final String QRC_BACK_TRANS_URL="acpsdk.qrcBackTransUrl";
//	// 人到人
//    private static final String QRC_B2C_ISS_BACK_TRANS_URL="acpsdk.qrcB2cIssBackTransUrl";
//	// 人到人
//    private static final String QRC_B2C_MER_BACK_TRANS_URL="acpsdk.qrcB2cMerBackTransUrl";
//
//
//	/** 配置文件中签名证书路径常量. */
//    static final String SDK_SIGNCERT_PATH = "acpsdk.signCert.path";
//	/** 配置文件中签名证书密码常量. */
//    static final String SDK_SIGNCERT_PWD = "acpsdk.signCert.pwd";
//	/** 配置文件中签名证书类型常量. */
//    static final String SDK_SIGNCERT_TYPE = "acpsdk.signCert.type";
//	/** 配置文件中密码加密证书路径常量. */
...
//	/** 配置文件中安全密钥 */
//    private static final String SDK_SECURITYKEY = "acpsdk.secureKey";
//	/** 配置文件中根证书路径常量  */
//    static final String SDK_ROOTCERT_PATH = "acpsdk.rootCert.path";
//	/** 配置文件中根证书路径常量  */
//    static final String SDK_MIDDLECERT_PATH = "acpsdk.middleCert.path";
//	/** 配置是否需要验证验签证书CN，除了false之外的值都当true处理 */
//    private static final String SDK_IF_VALIDATE_CN_NAME = "acpsdk.ifValidateCNName";
//	/** 配置是否需要验证https证书，除了true之外的值都当false处理 */
//    private static final String SDK_IF_VALIDATE_REMOTE_CERT = "acpsdk.ifValidateRemoteCert";
//	/** signmethod */
//    private static final String SDK_SIGN_METHOD ="acpsdk.signMethod";
//	/** version */
//    private static final String SDK_VERSION = "acpsdk.version";
//	/** 后台通知地址  */
//    private static final String SDK_BACKURL = "acpsdk.backUrl";
//	/** 前台通知地址  */
//    private static final String SDK_FRONTURL = "acpsdk.frontUrl";
//	/** 操作对象. */
