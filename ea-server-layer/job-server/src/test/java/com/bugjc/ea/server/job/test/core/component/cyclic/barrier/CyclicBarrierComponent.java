...
public class CyclicBarrierComponent {
    ...
    //可循环屏障具体业务逻辑对象
    private com.bugjc.ea.server.job.test.core.component.cyclic.barrier.CyclicBarrierTask cyclicBarrierTask;
    //线程池对象
    private ThreadPoolExecutor threadPoolExecutor;

    public CyclicBarrierComponent(int total, long timeout, com.bugjc.ea.server.job.test.core.component.cyclic.barrier.CyclicBarrierTask cyclicBarrierTask){
        this.total = total;
